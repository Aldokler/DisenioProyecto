...
public class ModeloExAdmision {
    ...
    public static void demoCitas() {
        ...
        for (Carrera carrera : carreras) {
            ...
            ListForms.addAll(elCtrl.getFormulariosPorCarrera_Estado(carrera));
    ...
    public static void main(String[] args) {
        ...
        for (Carrera carrera : carreras) {
            ...
            System.out.println("Carrera: " + carrera.getNombre() + "  Sede: " + carrera.getSede().getNombre() + '\n');
            viewCarreras.P9_mostrarResultadosExamenPorCarrera_Solicitante(carrera);
            System.out.println('\n' + "------------------------------------------");
        ...
        for (Carrera carrera : carreras) {
            ...
            System.out.println("Carrera: " + carrera.getNombre() + "  Sede: " + carrera.getSede().getNombre() + '\n');
            viewCarreras.P10_mostrarResultadosExamenPorCarrera_Estado(carrera);
            System.out.println('\n' + "------------------------------------------");
